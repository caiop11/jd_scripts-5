...
!(async () => {
  ...
  let res2 = await getAuthorShareCode('https://ghproxy.com/https://raw.githubusercontent.com/asd920/updateTeam/main/shareCodes/jxhb.json') || [];
...
function getAuthorShareCode(url = "https://ghproxy.com/https://raw.githubusercontent.com/asd920/updateTeam/main/shareCodes/jxhb.json") {
  return new Promise(resolve => {
    const options = {
